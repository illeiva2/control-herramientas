...
-- busquedas sin distinguir acentos ni enie (ILIKE + unaccent en la app)
CREATE EXTENSION IF NOT EXISTS unaccent;

-- una herramienta puede guardarse en varios lugares (ej: 2u en gondola 3 y 1u en gondola 5)
...
CREATE INDEX IF NOT EXISTS idx_ubic_hta ON ubicaciones(herramienta_id);
